                      ...
                      >
                        ...
                        <td className="p-3">
                          <div className="flex gap-2.5">
                            <span
                              className="text-[#658292] hover:text-[#7CB342] cursor-pointer"
                            ...
                            <span
                              className="text-[#658292] hover:text-red-600 cursor-pointer"
            ...
            <div className="fixed p-8 top-1/2 left-1/2 rounded-md transform -translate-x-1/2 -translate-y-1/2 bg-white z-50 ">
              ...
              <div className="flex justify-end gap-4 mt-4">
                <button
                  ...
                  className="py-2 px-4 border border-[#969696] rounded cursor-pointer bg-[grey] hover:bg-[#707070] text-white hover:text-white"
                >
                  Cancel
                </button>
                <button
